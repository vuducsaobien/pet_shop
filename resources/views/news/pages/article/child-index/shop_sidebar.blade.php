    ...
    <div class="recent-post-wrapper mt-25">
        <div class="single-recent-post mb-20">
            <div class="recent-post-img">
                <a href="#"><img src="{{ asset('news/images/blog/blog-s1.jpg') }}" alt=""></a>
            </div>
        ...
        <div class="single-recent-post mb-20">
            <div class="recent-post-img">
                <a href="#"><img src="{{ asset('news/images/blog/blog-s2.jpg') }}" alt=""></a>
            </div>
            <div class="recent-post-content">
        ...
        <div class="single-recent-post mb-20">
            <div class="recent-post-img">
                <a href="#"><img src="{{ asset('news/images/blog/blog-s3.jpg') }}" alt=""></a>
            </div>
            <div class="recent-post-content">
