...
use App\Models\TeamModel as MainModel;
use App\Http\Requests\TeamRequest as MainRequest ;
...
class TeamController extends AdminController
{
    ...
    {
        $this->pathViewController = 'admin.pages.team.';
        $this->controllerName = 'team';
    ...
    public function postChangeLoggedPassword(MainRequest $request, MessageBag $messageBag)
    {
        if ($request->method() == 'POST') {
            ...
            $teamModel = new MainModel();
            $teamInfo = $teamModel->getItem($params, ['task' => 'check-password']);
