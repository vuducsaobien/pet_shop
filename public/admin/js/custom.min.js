...
function init_flot_chart() {
    if (void 0 !== $.plot) {
        ...
        $("#chart_plot_02").length && (console.log("Plot2"), $.plot($("#chart_plot_02"), [{ label: "Email Sent", data: t, lines: { fillColor: "rgba(150, 202, 89, 0.12)" }, points: { fillColor: "#fff" } }], i)),
    ...
    if ("undefined" != typeof Gauge) {
        ...
        if (($("#gauge-text").length && ((t.maxValue = 6e3), (t.animationSpeed = 32), t.set(3200), t.setTextField(document.getElementById("gauge-text"))), $("#chart_gauge_02").length))
            var n = document.getElementById("chart_gauge_02"),
                i = new Gauge(n).setOptions(e);
        $("#gauge-text2").length && ((i.maxValue = 9e3), (i.animationSpeed = 32), i.set(2400), i.setTextField(document.getElementById("gauge-text2")));
    }
}
    ...
    if (void 0 !== $.fn.cropper) {
        ...
        var e = $("#image"),
            ...
            c = {
                ...
                preview: ".img-preview",
                crop: function (e) {
                    t.val(Math.round(e.x)), n.val(Math.round(e.y)), i.val(Math.round(e.height)), o.val(Math.round(e.width)), r.val(e.rotate), l.val(e.scaleX), s.val(e.scaleY);
                },
            };
        ...
        void 0 === a[0].download && a.addClass("disabled"),
            ...
            $(".docs-buttons").on("click", "[data-method]", function () {
                var t,
                    ...
                    i = $(this),
                    o = i.data();
                if (!i.prop("disabled") && !i.hasClass("disabled") && e.data("cropper") && o.method) {
                    if (void 0 !== (o = $.extend({}, o)).target && ((t = $(o.target)), void 0 === o.option))
                        try {
                            o.option = JSON.parse(t.val());
                        } catch (e) {
                            console.log(e.message);
                        }
                    switch (((n = e.cropper(o.method, o.option, o.secondOption)), o.method)) {
                        case "scaleX":
                        case "scaleY":
...
function init_knob() {
    if (void 0 !== $.fn.knob) {
        ...
        $("input.infinite").knob({
            ...
            stopper: !1,
            change: function () {
                e > this.cv ? (a ? (n--, i.show().html("-").fadeOut(), o.html(n), (a = 0)) : ((a = 1), (t = 0))) : e < this.cv && (t ? (n++, i.show().html("+").fadeOut(), o.html(n), (t = 0)) : ((t = 1), (a = 0))), (e = this.cv);
            },
        });
    }
}
                ...
                $(".tabbed_notifications > div").hide(),
                    ...
                    $(".notifications a").click(function (e) {
                        ...
                        var a = $(this),
                            ...
                            i = a.attr("href");
                        n.removeClass("active"), a.addClass("active"), $(t).children("div").hide(), $(i).show();
                    });
            }),
            CustomTabs();
        var a = (idname = "");
    ...
    if (void 0 !== $.fn.fullCalendar) {
        ...
        var e,
            ...
            o = $("#calendar").fullCalendar({
                ...
                select: function (a, t, n) {
                    $("#fc_create").click(),
                        ...
                        $(".antosubmit").on("click", function () {
                            var a = $("#title").val();
                            return t && (ended = t), $("#event_type").val(), a && o.fullCalendar("renderEvent", { title: a, start: e, end: t, allDay: n }, !0), $("#title").val(""), o.fullCalendar("unselect"), $(".antoclose").click(), !1;
                        });
                },
                ...
                editable: !0,
                events: [
                    { title: "All Day Event", start: new Date(i, n, 1) },
                    { title: "Long Event", start: new Date(i, n, t - 5), end: new Date(i, n, t - 2) },
                    { title: "Meeting", start: new Date(i, n, t, 10, 30), allDay: !1 },
                    { title: "Lunch", start: new Date(i, n, t + 14, 12, 0), end: new Date(i, n, t, 14, 0), allDay: !1 },
                    { title: "Birthday Party", start: new Date(i, n, t + 1, 19, 0), end: new Date(i, n, t + 1, 22, 30), allDay: !1 },
                    { title: "Click for Google", start: new Date(i, n, 28), end: new Date(i, n, 29), url: "http://google.com/" },
                ],
            });
    }
}
            ...
            ? this.bind(
                ...
                (function (e, a, t) {
                    ...
                    return function () {
                        var i = this,
                            o = arguments;
                        n ? clearTimeout(n) : t && e.apply(i, o),
                            (n = setTimeout(function () {
                                t || e.apply(i, o), (n = null);
                            }, a || 100));
                    };
                })(e)
            )
